...
5. Wave your hand in front of the CYBT-213043-MESH board to show some motion. (See notes below for motion sensor).
...
3. The PIR motion sensor is available only for CYBT-213043-MESH kit. For all other kits supported by this app, only the button can be used for control.
